...
async def ask_for_phone(chat_id: int, bot: Bot):
    """запрос номера телефона для неавторизованных пользователей"""
    await bot.send_message(chat_id=chat_id,text="дай номер телефона для заказа",reply_markup= phone_button() )